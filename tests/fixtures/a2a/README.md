...
- `FIXTURE_planets_hybrid-v1.0-card.json`: protocol `1.0` payload captured from the legacy `https://planets-agent.ai/.well-known/agent.json` fetch path (original filename: `FIXTURE_planets_v0.3_agent-card.json`)
